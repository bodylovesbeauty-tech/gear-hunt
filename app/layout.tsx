...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" className={`${geist.variable} ${geistMono.variable}`}><body><PreferenceProvider><SiteChrome>{children}</SiteChrome><GlobalExperienceLayer/></PreferenceProvider></body></html>}
