...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'BBBT | Critical Rider Safety Infrastructure', description: 'The trust protocol for India\'s riders. Instant highway SOS tracking, verified blood mesh coordination, and trauma center routing.', type: 'website', siteName: 'BBBT', locale: 'en_IN', url: siteUrl },
  twitter: { card: 'summary_large_image', title: 'BBBT | Critical Rider Safety Infrastructure', description: 'The trust protocol for India\'s riders.' },
