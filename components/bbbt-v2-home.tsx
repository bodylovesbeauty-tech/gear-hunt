...
export function BbbtV2Home() {
  ...
  return (
    <main className="v2-home">
      ...
      <section className="v2-split"><div className="v2-trust"><p className="v2-kicker">BBBT TRUST</p><h2>People first.<br /><span>Always.</span></h2><p>Safety, welfare, learning, community accountability, governance, and rider support.</p><Link href="/safety">Explore the Trust ↗</Link></div><div className="v2-holding"><p className="v2-kicker">BBBT HOLDING</p><h2>Ideas into<br /><span>infrastructure.</span></h2><p>Products, technology, research, partnerships, and the future BBBT Shop.</p><Link href="/partners">Explore the Holding ↗</Link></div></section>
