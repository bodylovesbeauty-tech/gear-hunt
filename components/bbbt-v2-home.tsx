...
export function BbbtV2Home() {
  ...
  return (
    <main className="v2-home">
      ...
      <header className="v2-nav"><Link className="v2-brand" href="/" aria-label="BBBT home"><img src="/bbbt-logo-red.png" alt="BBBT"/><small>BRAND BIKER BROTHERHOOD TRUST</small></Link><nav aria-label="Primary navigation"><Link href="/about">What is BBBT?</Link><Link href="/signup">For Riders</Link><Link href="/safety">Safety</Link><Link href="/community">Community</Link><Link href="/care-pits">Care Pit</Link><Link href="/investor">Investor Brief</Link></nav><div className="v2-nav-actions"><Link className="v2-nav-login" href="/login">Login</Link><Link className="v2-button v2-button-red" href="/signup">Join BBBT</Link></div></header>
      ...
      <footer className="v2-footer"><div><div className="v2-brand"><img src="/bbbt-logo-red.png" alt="BBBT"/><small>BRAND BIKER BROTHERHOOD TRUST</small></div><p>Rider safety infrastructure,<br />designed with responsibility.</p></div><div className="v2-footer-links"><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/contact">Contact</Link><Link href="/login">{t('nav.login',preferences.language)} ↗</Link><GlobalPreferencesControl footer/></div><small>INDIA / 2026 / PROTOTYPE</small></footer>
    </main>
  )
}
