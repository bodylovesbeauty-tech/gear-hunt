...
export function GlobalExperienceLayer() {
  ...
  return <>
    <aside className="global-quick-access" aria-label="Global quick access">
      ...
      <button type="button" onClick={() => setCalculatorOpen((open) => !open)} aria-expanded={calculatorOpen}>Currency</button>
      <GlobalPreferences />
