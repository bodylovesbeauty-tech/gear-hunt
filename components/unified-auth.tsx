...
export function UnifiedSignup(){
  ...
  if(done)return <AuthFrame>
    ...
    <div className="status-detail">
      ...
      <span>Application ID</span><strong>{JSON.parse(sessionStorage.getItem(applicationKey)||'{}').applicationId||'BBBT-PROTO-PENDING'}</strong><span>Application status</span><strong>Pending / Prototype</strong>
    </div>
