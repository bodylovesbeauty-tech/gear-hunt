...
export type PrototypeGroup={id:string;name:string;createdAt:string;cycleStart:string;cycleEnd:string;adminId:string;members:GovernanceMember[];elections:GovernanceElection[];rides:GovernanceRide[];notifications:GovernanceNotification[];shareToken?:string;image?:{name:string;dataUrl:string}|null}
