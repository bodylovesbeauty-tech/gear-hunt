...
export type PrototypeIdentity={id:string;applicationId:string;fullName:string;handle:string;mobile:string;email:string;requestedRole:Role;status:Status;selectedLanguages:string[];vehicles:PrototypeVehicle[];address?:string;city?:string;state?:string;district?:string;pinCode?:string;bbbtZone?:string;emergencyName?:string;emergencyNumber?:string;bloodGroup?:string;profilePhoto?:{name:string;dataUrl:string}|null;bloodReport?:{name:string;dataUrl:string}|null;createdAt:string}
