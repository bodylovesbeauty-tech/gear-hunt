...
export type ComplaintRecord={id:string;subjectId:string;filedBy:string;evidence:{name:string;type:string;url?:string}[];status:'OPEN'|'UNDER_REVIEW'|'RESOLVED';outcome?:'NO_ACTION'|'WARNING'|'SUSPENSION'|'PERMANENT_BLOCK';createdAt:string;resolvedAt?:string}
